...
namespace SqlXY
{
    public class NpgSqlExecuteXY :ListDeserializerBase, IDisposable
    {
        ...
        /// CONN连接对象池
        /// </summary>
        public static Dictionary<string, ObjectPool<NpgsqlConnection>> DBConnPool { get; private set; }
        ...
        public NpgSqlExecuteXY()
        {
            ...
            DBConn = NpgSqlExecuteXY.DBConnPool["DefautConnectionString"].GetObject();
            if (DBConn == null)
            {
            ...
            Command = NpgSqlExecuteXY.DBCommandPool.GetObject();
        ...
        public NpgSqlExecuteXY(string key)
        {
            ...
            DBConn = NpgSqlExecuteXY.DBConnPool[key].GetObject();
        ...
        public void Dispose(bool isDispose)
        {
            ...
            else
            {
                ...
                if (DBConn != null)
                {
                    NpgSqlExecuteXY.DBConnPool[this.Key].ReleaseObject(DBConn);
                }
                if (Command != null)
                    NpgSqlExecuteXY.DBCommandPool.ReleaseObject(Command);
        ...
        /// <param name="sql">SQL语句</param>
        /// <returns></returns>
        public NpgsqlDataReader SqlExecuteReader(string sql, CommandBehavior commandBehavior = CommandBehavior.SingleResult)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public NpgsqlDataReader SqlExecuteReader(string sql, bool bolIsProcedure, CommandBehavior commandBehavior = CommandBehavior.SingleResult)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public NpgsqlDataReader SqlExecuteReader(string sql, CommandBehavior commandBehavior, params NpgsqlParameter[] parem)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public NpgsqlDataReader SqlExecuteReader(string sql, bool bolIsProcedure, CommandBehavior commandBehavior, params NpgsqlParameter[] parem)
        {
            lock (LockThis)
            {
                Command.CommandText = sql;
        ...
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, string tablename, params NpgsqlParameter[] parem) where T : new()
        {
        ...
        /// <param name="bolIsProcedure">是否为存储过程</param>        
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, params NpgsqlParameter[] parem) where T : new()
        {
            T b;
        ...
        /// <param name="bolIsProcedure">是否为存储过程</param>        
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, string tableName, params NpgsqlParameter[] parem) where T : new()
        {
            T b;
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, out T obj, string tableName, params NpgsqlParameter[] parem) where T : new()
        {
        ...
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, out T obj, string tablename, params NpgsqlParameter[] parem) where T : new()
        {
