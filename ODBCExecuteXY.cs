...
namespace SqlXY
{
    public class ODBCExecuteXY:ListDeserializerBase, IDisposable
    {
        ...
        /// CONN连接对象池
        /// </summary>
        public static Dictionary<string, ObjectPool<System.Data.Odbc.OdbcConnection>> DBConnPool { get; private set; }
        public static ObjectPool<OdbcCommand> DBCommandPool { get; private set; }




        static ODBCExecuteXY()
        {
            DBConnPool = GetSqlPoolHandler.GetOdbcConnInstance();         
            DBCommandPool = GetSqlPoolHandler.GetOdbcCommandInstance();
        ...
        public ODBCExecuteXY()
        {
            ...
            DBConn = ODBCExecuteXY.DBConnPool["DefautConnectionString"].GetObject();
            if (DBConn == null)
            {
            ...
            Command = ODBCExecuteXY.DBCommandPool.GetObject();
        ...
        public ODBCExecuteXY(string key)
        {
            ...
            DBConn = ODBCExecuteXY.DBConnPool[key].GetObject();
        ...
        public void Dispose(bool isDispose)
        {
            ...
            else
            {
                ...
                if (DBConn != null)
                {
                    ODBCExecuteXY.DBConnPool[this.Key].ReleaseObject(DBConn);
                }
                if (Command != null)
                    ODBCExecuteXY.DBCommandPool.ReleaseObject(Command);
        ...
        /// <param name="sql">SQL语句</param>
        /// <returns></returns>
        public OdbcDataReader SqlExecuteReader(string sql ,CommandBehavior commandBehavior = CommandBehavior.SingleResult)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public OdbcDataReader SqlExecuteReader(string sql, bool bolIsProcedure, CommandBehavior commandBehavior = CommandBehavior.SingleResult)
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public OdbcDataReader SqlExecuteReader(string sql, CommandBehavior commandBehavior, params OdbcParameter[] parem)
        {
        ...
        /// <param name="bolIsProcedure">是否存储过程</param>
        /// <returns></returns>
        public OdbcDataReader SqlExecuteReader(string sql, bool bolIsProcedure, CommandBehavior commandBehavior,params OdbcParameter[] parem)
        {
            lock (LockThis)
            {
                Command.CommandText = sql;
        ...
        /// <param name="parem">参数</param>      
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, params OdbcParameter[] parem) where T : new()
        {
        ...
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, string tablename, params OdbcParameter[] parem) where T : new()
        {
        ...
        /// <param name="bolIsProcedure">是否为存储过程</param>        
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, params OdbcParameter[] parem) where T : new()
        {
            T b;
        ...
        /// <param name="bolIsProcedure">是否为存储过程</param>        
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, string tableName, params OdbcParameter[] parem) where T : new()
        {
            T b;
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, out T obj, params OdbcParameter[] parem) where T : new()
        {
        ...
        public int SqlExcuteSelectFirst<T>(string sql, out T First, params OdbcParameter[] parem) where T : new()
        {
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, out T obj, string tableName, params OdbcParameter[] parem) where T : new()
        {
        ...
        /// <returns>对象集合</returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, out T obj, string tablename, params OdbcParameter[] parem) where T : new()
        {
