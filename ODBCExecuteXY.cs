...
namespace SqlXY
{
    public class ODBCExecuteXY : ListDeserializerBase, IDisposable
    {
        ...
        ///     CONN连接对象池
        /// </summary>
        public static Dictionary<string, ObjectPool<OdbcConnection>> DbConnPool { get; }

        public static ObjectPool<OdbcCommand> DbCommandPool { get; }
        ...
        public List<T> SqlExcuteSelectObject<T>(string sql, bool bolIsProcedure, string tableName,
            params OdbcParameter[] parem) where T : new()
        {
            T b;
        ...
        /// <param name="parem">参数</param>
        /// <returns></returns>
        public List<T> SqlExcuteSelectObject<T>(string sql, out T obj, string tableName, params OdbcParameter[] parem)
            where T : new()
        {
